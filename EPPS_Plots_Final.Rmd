---
title: "Dallas County: Education vs Crime — Interactive Visuals & Regression Models"
output:
  html_document:
    toc: true
    toc_float: true
...
This report explores how **educational outcomes** (Graduation Rate and College/Career/Military Readiness — **CCMR**) relate to **violent** and **property crime** across **Dallas County** districts.
...
Your regression code, unchanged, running on the same CSV (read separately as `dat`):
...
-   Poverty has the strongest and most consistent factor related to both crime and educational outcomes. Districts with more poverty usually have more crime and lower student performance.
